...
"C:\MinGW32-xy\bin\mingw32-gcc.exe" -shared -o _truncated_normal.pyd truncated_normal.o truncated_normal_wrap.o -L"C:\Python27\libs" -lpython27 -Wl,--out-implib,libtruncated_normal.a
